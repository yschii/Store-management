...
namespace RM.View
{
    public partial class frmBoardView : Form
    {
        public frmBoardView()
        {
            InitializeComponent();
        ...
        public void completeOrders()
        {
            ...
            string qry1 = @"Select * from tblMain where status = 'complete' ";
            SqlCommand cmd1 = new SqlCommand(qry1, MainClass.con);
            DataTable dt1 = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd1);
            da.Fill(dt1);
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                b.Margin = new Padding(350, 0, 0, 0);
                b.Text = "V";
        ...
        private void _Click(object sender, EventArgs e)
        {
            ...
            {
                string qry = @"Update tblMain Set status = 'done' where MainID = @ID";
        ...
        private void frmBoardView_Load(object sender, EventArgs e)
        {
            GetOrders();
            completeOrders();
        }
